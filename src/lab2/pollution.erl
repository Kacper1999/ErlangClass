...
test() ->
    ...
    P3 = add_value("hi", calendar:local_time(), "PM10", 10, P2),
    P4 = remove_value("hi", calendar:local_time(), "PM10", P3),
    P5 = add_value("hid", calendar:local_time(), "TEMP", 3, P4),
    timer:sleep(1),

    P6 = add_value("hi", calendar:local_time(), "TEMP", 2, P5),
    P7 = add_value("hid", calendar:local_time(), "PM10", 11, P6),
    print_monitor(P7),
    ...
    io:format("local time ~p~n", [calendar:local_time()]),
    io:format("hi pm10 curr time value: ~p~n", [get_value("hid", calendar:local_time(), "PM10", P7)]),

    io:format("daily temp mean: ~p~n", [get_daily_mean({2020, 4, 7}, "TEMP", P7)]),
    io:format("daily pm10 mean: ~p~n", [get_daily_mean({2020, 4, 7}, "PM10", P7)]),
    io:format("hourly pm10 mean: ~p~n", [get_hourly_mean({2020, 4, 7}, 18, "PM10", P7)]),
    io:format("daily temp max: ~p~n", [get_daily_max({2020, 4, 7}, "TEMP", P7)]).
