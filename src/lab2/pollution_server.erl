...
-behavior(gen_server).
%% API
-export([init/1, handle_call/3, handle_cast/2, start/0, stop/0, get_value/3, get_station_mean/2, get_daily_mean/2, get_hourly_mean/3, get_daily_max/2, add_station/2, add_value/4, remove_value/3, print_monitor/0]).
